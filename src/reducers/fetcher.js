import { FETCH_SIGN_UP_REQUEST, FETCH_SIGN_UP_FAILURE, FETCH_SIGN_UP_SUCCESS, FETCH_SIGN_OUT_REQUEST, FETCH_SIGN_OUT_FAILURE, FETCH_SIGN_OUT_SUCCESS, SET_FETCHED_ALREADY, FETCH_LYFT_TOKEN_REQUEST, FETCH_LYFT_TOKEN_SUCCESS, FETCH_LYFT_TOKEN_FAILURE, FETCH_SIGN_IN_REQUEST, FETCH_SIGN_IN_SUCCESS, FETCH_SIGN_IN_FAILURE,FETCH_METRICS_REQUEST,FETCH_METRICS_SUCCESS, FETCH_METRICS_FAILURE,FETCH_YELP_REQUEST, FETCH_YELP_SUCCESS, FETCH_YELP_FAILURE,FETCH_SORT_REQUEST, FETCH_SORT_SUCCESS, FETCH_SORT_FAILURE, FETCH_RECOMMENDATION_REQUEST, FETCH_RECOMMENDATION_SUCCESS, FETCH_RECOMMENDATION_FAILURE } from '../constants/ActionTypes'
...
export default function fetcher(state = initialState, action) {
  switch(action.type) {
    ...
    case FETCH_RECOMMENDATION_REQUEST:
      return Object.assign({}, state, { isFetchingRecommendations: true });
    case FETCH_RECOMMENDATION_SUCCESS:
      return Object.assign({}, state, { isFetchingRecommendations: false });
